...
public class CopyOfLudoSplashActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Faststart for debug
        startActivity(new Intent(CopyOfLudoSplashActivity.this, LudoChooseGameActivity.class));
    	CopyOfLudoSplashActivity.this.finish();
    	// End faststart
    ...
    private void endAnimation()
    {
        ...
        lAnimation1.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
            	...
            	startActivity(new Intent(CopyOfLudoSplashActivity.this, LudoStartNewGameActivity.class));
            	CopyOfLudoSplashActivity.this.finish();
            }
