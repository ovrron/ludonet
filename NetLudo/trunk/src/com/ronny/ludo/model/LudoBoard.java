...
public interface LudoBoard{
	
	void addPlayer(PlayerColor pc, Player pl);
	/**
	...
	Player getPlayer(String theColor);
	 ...
	 * @return
	 */
	Coordinate getBoardPosition(int position);
	/**
	...
	void addBaseHomeDefs(String col, Vector<Coordinate> baseHome);
	// Add the way home definitions for a player
	void addWayHomeDefs(String col, Vector<Coordinate> wayHome);
