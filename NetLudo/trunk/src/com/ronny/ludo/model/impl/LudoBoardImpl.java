...
public class LudoBoardImpl implements LudoBoard {
	...
	public LudoBoardImpl() {
		players.put(PlayerColor.RED, new PlayerImpl(PlayerColor.RED,this));
		players.put(PlayerColor.GREEN, new PlayerImpl(PlayerColor.GREEN,this));
		players.put(PlayerColor.YELLOW, new PlayerImpl(PlayerColor.YELLOW,this));
		players.put(PlayerColor.BLUE, new PlayerImpl(PlayerColor.BLUE,this));
	}
